...
function aafm_ability_disclosures(): array {
	return array(
		...
		'aafm/wc-update-order-status'      => __( 'Sets the status of a WooCommerce order and optionally adds a customer note. Returns only the order id, number, and new status — no PII. Requires the manage-WooCommerce capability.', 'agent-abilities-for-mcp' ),
